...
const myexp = ((request, response) => {
    ...
    const knowladge_What_is_Alcohol = async () => {
        ...
        agent.add("ซึ่งคนส่วนใหญ่ยังไม่ได้ตระหนักว่ามันคือ ❗️สารเสพติดที่อันตราย❗️ ทั้งจากตัวของมันเองและเป็นอันตรายในฐานะที่เป็นจุดเริ่มต้นที่นำไปสู่การเสพยาเสพติดอื่น ๆ ตามมา ซึ่งก่อให้เกิดผลเสียทั้งทางด้านร่างกาย จิตใจ อารมณ์และสังคม");;
    }
