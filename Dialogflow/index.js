    ...
    const knowladgeSection = async () => {
        ...
        const knowladge_Effect = async () => {
            ...
            const knowladge_Neural = async () => {
                return agent.add(new Payload(`LINE1` , {
                    "type": "text",
