...
const myexp = ((request, response) => {
    ...
    const knowladge_WithdrawalkSymptoms = async () => {
        ...
        agent.add(" โดยสำหรับผู้ที่ดื่มสุรามานานหรือผู้ที่ดื่มติดต่อกันมานานหลายวันแล้วทำการหยุดดื่มสุราลงหรือลดปริมาณลงอย่างกระทันหันจะก่อให้การตื่นตัวของระบบประสาทอัตโนมัติซึ่งนำไปสู่อาการผิดปกติต่างๆ เช่น วิตกกังวล รู้สึกกระวนกระวาย มือสั่น ใจสั่น พูดเพ้อ สับสน ประสาทหลอนและเกิดอาหารชักในบางกรณี ซึ่งโดยส่วนใหญ่แล้วในผู้ป่วยกลุ่มนี้จะมีอาการถอนเกิดขึ้นหลังหยุดดื่ม 2-3 วันจนถึง 1 สัปดาห์ขึ้นไป") ;
        agent.add("สำหรับผู้ที่ดื่มจนถึงขั้นติดสุราโดยทั่วไปแล้วจะเกิดอาการถอนสุราภายใน 6-8 ชม. แรกหลังจากหยุดดื่ม และมีอาการผิดปกติต่างๆ เช่น มีอาการสั่น คลื่นไส้ อาเจียน เหงื่อแตก หัวใจเต้นเร็ว ความดันโลหิตสูง วิตกกังวล หงุดหงิดกระสับกระส่าย โดยอาการถอนมักจะรุนแรงที่สุดในช่วง 24-26 ชม. หลังจากที่ทำการหยุดดื่มและหลังจากนั้นอาการจะค่อยๆหายไปภายใน 3-4 วันและจะเรียกอาการช่วงนั้นว่า ‘การถอนสุราแบบธรรมดา’");
    }
