...
/* แบบสาม 3 วัน
 ...
 //สำหรับ 3 วัน 
    ...
    const riskAssessmentResultWeek = async () => {
        ...
        var sumSdPoint = (sdPoint[0] + sdPoint[1] + sdPoint[2] + sdPoint[3] + sdPoint[4] + sdPoint[5] + sdPoint[6]).toFixed(1);
    ...
    /*
    const riskAssessmentResultDayInfo = async () => {
        agent.add("น้องตั้งใจขอแนะนำปริมาณการดื่มที่ปลอดภัยใน 1 สัปดาหืให้คุณได้ทราบค่ะ");
        ...
        agent.add("แต่อย่างไรก็ตาม น้องตั้งใจแนะนำว่าคุณไม่ควรดื่มเลยจะดีที่สุดค่ะ");
...
*/
    ...
    const assessGoal = async () => { // ขั้นตอนที่ 7 และ 8
        ...
        if (age > 65) {
            if (gender === "ชาย") { // 1A
                agent.add("ในหนึ่งสัปดาห์ หากคุณดื่มเบียร์ ต้องดื่มไม่เกิน 7️⃣ กระป๋อง หรือ หากดื่มไวน์ต้องดื่มไม่เกิน  1️⃣0️⃣ แก้ว หรือหากดื่มสุราสี 35 ดีกรี ต้องดื่มไม่เกิน 2️⃣ แก้ว");
                agent.add("และในหนึ่งวัน คุณดื่มเบียร์ได้ไม่เกิน 3️⃣ กระป๋อง หรือ หากดื่มไวน์ ต้องดื่มไม่เกิน 3️⃣ แก้ว หรือ หากดื่มสุราสี 35 ดีกรี ต้องดื่มไม่เกิน 1️⃣ แก้ว");
                ...
                agent.add("ในหนึ่งสัปดาห์ หากคุณดื่มเบียร์ ต้องดื่มไม่เกิน 7️⃣ กระป๋อง หรือ หากดื่มไวน์ ต้องดื่มไม่เกิน 8️⃣ แก้ว หรือ หากดื่มสุราสี 35 ดีกรี ต้องดื่ืไม่เกิน 2️⃣ แก้ว");
                agent.add("และในหนึ่งวัน คุณดื่มเบียร์ได้ไม่เกิน 3️⃣ กระป๋อง หรือ หากดื่มไวน์ ต้องดื่มไม่เกิน 3️⃣ แก้ว หรือ หากดื่มสุราสี 35 ดีกรี ต้องดื่มไม่เกิน 1️⃣ แก้ว");
            ...
            if (gender === "ชาย") { // 1C
                agent.add("ในหนึ่งสัปดาห์ หากคุณดื่มเบียร์ต้องดื่ไม่เกิน 1️⃣5️⃣ กระป๋อง หรือ หากดื่มไวน์ต้องดื่มไม่เกิน 1️⃣6️⃣ แก้ว หรือ หากดื่มสุราสี 35 ดีกรีต้องดื่มไม่เกิน 4️⃣ แก้ว");
                agent.add("และในหนึ่งวัน คุณดื่มเบียร์ได้ไม่เกิน 4️⃣ กระป๋อง หรือหากดื่มไวน์ต้องดื่มไม่เกิน 4️⃣ แก้ว หรือหากดื่มสุราสี 35 ดีกรี ต้องดื่มไม่กิน 1️⃣ แก้ว");
                agent.add(new Image("https://firebasestorage.googleapis.com/v0/b/nong-tung-jai-68673.appspot.com/o/%E0%B8%AA%E0%B8%B2%E0%B8%A3%E0%B8%B0%E0%B8%84%E0%B8%A7%E0%B8%B2%E0%B8%A1%E0%B8%A3%E0%B8%B9%E0%B9%89%2F%E0%B8%81%E0%B8%B2%E0%B8%A3%E0%B8%94%E0%B8%B7%E0%B9%88%E0%B8%A1%E0%B8%9B%E0%B8%A5%E0%B8%AD%E0%B8%94%E0%B8%A0%E0%B8%B1%E0%B8%A2-%E0%B8%8A%E0%B8%B2%E0%B8%A2.png?alt=media&token=6a7ae3bf-4ee9-46d0-8134-b6974850da04"));
                // แนบ Infographic
            } else if (gender === "หญิง") { // 1D
                agent.add("ในหนึ่งสัปดาห์ หากคุณดืมเบียร์ต้องดื่มไม่เกิน 7️⃣ กระป๋อง หรือหากดื่มไวน์ต้องดื่มไม่เกิน 8️⃣ แก้ว หรือหากดื่มสุราสี 35 ดีกรี ต้องดื่มไม่เกิน 2️⃣ แก้ว");
                agent.add("และในหนึ่งวัน คุณดื่มเบียร์ได้ไม่เกิน 3️⃣ กระป๋อง หรือหากดื่มไวน์ต้องดื่มไม่เกิน 3️⃣ แก้ว หรือหากดื่มสุราสี 35 ดีกรี ต้องดื่มไม่เกิน 1️⃣ แก้ว");
                agent.add(new Image("https://firebasestorage.googleapis.com/v0/b/nong-tung-jai-68673.appspot.com/o/%E0%B8%AA%E0%B8%B2%E0%B8%A3%E0%B8%B0%E0%B8%84%E0%B8%A7%E0%B8%B2%E0%B8%A1%E0%B8%A3%E0%B8%B9%E0%B9%89%2F%E0%B8%81%E0%B8%B2%E0%B8%A3%E0%B8%94%E0%B8%B7%E0%B9%88%E0%B8%A1%E0%B8%9B%E0%B8%A5%E0%B8%AD%E0%B8%94%E0%B8%A0%E0%B8%B1%E0%B8%A2-%E0%B8%AB%E0%B8%8D%E0%B8%B4%E0%B8%87.png?alt=media&token=304c999f-c340-429b-9e1c-48d3b36834c7"));
                // แนบ Infographic
            } else {
                console.log("Gender value error : ", gender);
            ...
            agent.add("กฏหมายได้ห้ามขายเครื่องดื่มแอลกออฮอล์ให้้คุณ หากอายุของคุณต่ำกว่า 2️⃣0️⃣ ปี ดังนั้นการดื่มไม่ว่าในปริมาณเท่าใดก็อาจยังไม่เหมาะสมนะคะ");
        } else {
        ...
        agent.add("❗️❗️ หากคุณไม่สามารถควบคุมการดื่มของคุณให้ต่ำกว่านะดับที่น้องตั้งใจบอกนี้ได้ คุณมีความเสี่ยงที่จะเกิดปัญหา หรือเสี่ยงที่จะติดแอลกอฮอล์ได้นะคะ ❗️❗️");
    }
    ...
    const knowladge_HowToUse = async () => {
        agent.add("น้องตั้งใจขอแนะนำวิธีการใช้งานน้องตั้งใจในส่วนของข้อมูลเลิกเหล้าค่ะ") ;
        return agent.add(new Image("https://firebasestorage.googleapis.com/v0/b/nong-tung-jai-68673.appspot.com/o/%E0%B8%AA%E0%B8%B2%E0%B8%A3%E0%B8%B0%E0%B8%84%E0%B8%A7%E0%B8%B2%E0%B8%A1%E0%B8%A3%E0%B8%B9%E0%B9%89%2F%E0%B9%81%E0%B8%9C%E0%B8%99%E0%B8%9C%E0%B8%B1%E0%B8%87%E0%B8%82%E0%B9%89%E0%B8%AD%E0%B8%A1%E0%B8%B9%E0%B8%A5%E0%B9%80%E0%B8%A5%E0%B8%B4%E0%B8%81%E0%B9%80%E0%B8%AB%E0%B8%A5%E0%B9%89%E0%B8%B2%20.png?alt=media&token=1bd6dfab-abc9-4e66-b762-c6124d47131a"));
    }
    ...
    const ErrorMessages = async () => {
        agent.add("น้องตั้งใจไม่เข้าใจค่ะ");
        agent.add("ขออนุญาตแนะนำการใช้งานน้องตั้งใจนะคะ");
        agent.add(new Image("https://firebasestorage.googleapis.com/v0/b/nong-tung-jai-68673.appspot.com/o/%E0%B8%AA%E0%B8%B2%E0%B8%A3%E0%B8%B0%E0%B8%84%E0%B8%A7%E0%B8%B2%E0%B8%A1%E0%B8%A3%E0%B8%B9%E0%B9%89%2F%E0%B9%81%E0%B8%99%E0%B8%B0%E0%B8%99%E0%B8%B3%E0%B8%81%E0%B8%B2%E0%B8%A3%E0%B9%83%E0%B8%8A%E0%B9%89%E0%B8%87%E0%B8%B2%E0%B8%99%E0%B8%99%E0%B9%89%E0%B8%AD%E0%B8%87%E0%B8%95%E0%B8%B1%E0%B9%89%E0%B8%87%E0%B9%83%E0%B8%88.png?alt=media&token=ff62ff52-7aab-4961-9605-9dd99afc9975"));
        agent.add("เนื่องจากน้องตั้งใจ เป็นบอทให้คำแนะนำมือใหม่ และระบบยังต้องการการพัฒนาอีกมาก หากเกิดปัญหาขัดข้องระหว่างพูดคุย 🤷🏽‍♀️ กรุณากดเลือก “บล็อค” ที่ปุ่มคำสั่งที่มุมบนขวาของหน้าจอ และกด “ปลดบล๊อค” เพื่อให้น้องตั้งใจเริ่มต้นการทำงานใหม่ค่ะ หรือหากอยู่เมนูใดก็ตามคุณสามารถพิมพ์คำว่า 'ยกเลิก' ได้เช่นกันค่ะ");
    }
    ...
    intentMap.set('knowladge', knowladgeSection);
        intentMap.set('knowladge_HowToUse', knowladge_HowToUse);
    ...
    intentMap.set('Error Messages',ErrorMessages);
